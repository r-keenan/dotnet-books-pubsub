...
var schemaRegistry = builder
    ...
    .WithEnvironment("SCHEMA_REGISTRY_RETRY_BACKOFF_MS", "10000")
    .WithEnvironment("SCHEMA_REGISTRY_RETRY_COUNT", "50")
    .WithEnvironment("SCHEMA_REGISTRY_CONNECTION_TIMEOUT_MS", "180000")
    .WithEnvironment("SCHEMA_REGISTRY_READ_TIMEOUT_MS", "180000")
    .WithEnvironment("SCHEMA_REGISTRY_KAFKASTORE_TIMEOUT_MS", "180000")
    .WithEnvironment("SCHEMA_REGISTRY_KAFKASTORE_INIT_TIMEOUT_MS", "180000")
